...
**Status:** Reference. Describes `main` as of 2026-09-12, release 0.2.0.
...
flowchart LR
  ...
  subgraph VM["Virtual machine · docker compose project agentchat-deploy"]
    ...
    SRV["server<br/>ghcr.io/anmol098/agentchat-server:0.2.0<br/>PORT 3000, uid 1000, no host port<br/>MIGRATE_ON_BOOT=false"]
...
sequenceDiagram
  ...
  L->>H: GET /ws upgrade · X-AgentChat-Client: agentchat/0.2.0 · Bearer token
