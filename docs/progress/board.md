...
| [T-066](./tasks/T-066.md) | Give docs/cli.md the guard that has kept docs/protocol.md honest | Done | claude-fable | — |
...
| [T-063](./tasks/T-063.md) | The release rehearsal cannot rehearse a release | Done | claude-fable | — |
...
| [T-073](./tasks/T-073.md) | Release 0.2.1, so a deployed server stops reporting live listeners as offline | Done | claude-fable | T-069 |
...
| [T-515](./tasks/T-515.md) | Installing the CLI globally doesn't also get you its Skill | Todo | — | — |
