 ...
 * testable without a subprocess, input included.
 *
 * @module
 */
...
export type { CliEnvironment, InputStream, OutputStream } from './streams.js';
export { isBrokenPipe, StreamSink, StreamSource } from './streams.js';
